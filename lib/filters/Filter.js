...
var Filter = /** @class */ (function () {
    function Filter(config) {
        ...
        if (config === null || config === void 0 ? void 0 : config.allLanguages) {
            ...
            var languages = (config === null || config === void 0 ? void 0 : config.languages) || ["en"];
    ...
    Filter.prototype.evaluate = function (text, customWords) {
        ...
        try {
            ...
            for (var words_2 = __values(words), words_2_1 = words_2.next(); !words_2_1.done; words_2_1 = words_2.next()) {
                ...
                try {
                    for (var _d = (e_6 = void 0, __values(__spreadArray(__spreadArray([], __read(customWords), false), __read(this.words.keys()), false))), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var dictWord = _e.value;
                        var severity = this.evaluateSeverity(dictWord, word);
                        if (severity !== undefined &&
                            !this.ignoreWords.has(dictWord.toLowerCase())) {
