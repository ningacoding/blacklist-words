...
var Filter = /** @class */ (function () {
    function Filter(config) {
        ...
        if (config === null || config === void 0 ? void 0 : config.allLanguages) {
            ...
            var languages = (config === null || config === void 0 ? void 0 : config.languages) || ['english'];
    ...
    Filter.prototype.isProfane = function (value) {
        var e_1, _a;
        try {
            for (var _b = __values(this.words.keys()), _c = _b.next(); !_c.done; _c = _b.next()) {
                var word = _c.value;
    ...
    Filter.prototype.checkProfanityInSentence = function (text) {
        ...
        try {
            for (var words_1 = __values(words), words_1_1 = words_1.next(); !words_1_1.done; words_1_1 = words_1.next()) {
                ...
                try {
                    for (var _d = (e_3 = void 0, __values(this.words.keys())), _e = _d.next(); !_e.done; _e = _d.next()) {
    ...
    Filter.prototype.checkProfanity = function (text) {
        ...
        try {
            ...
            for (var words_2 = __values(words), words_2_1 = words_2.next(); !words_2_1.done; words_2_1 = words_2.next()) {
                ...
                try {
                    for (var _d = (e_6 = void 0, __values(this.words.keys())), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var dictWord = _e.value;
                        var severity = this.evaluateSeverity(dictWord, word);
                        if (severity !== undefined && !this.ignoreWords.has(dictWord.toLowerCase())) {
                            profaneWords.push(word);
        ...
        var sentenceResult = this.checkProfanityInSentence(text);
