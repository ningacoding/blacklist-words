...
var Filter = /** @class */ (function () {
    ...
    function Filter(config) {
        var _a, _b, _c, _d, _e;
        var words = [];
        this.similarityPercent = (config === null || config === void 0 ? void 0 : config.similarityPercent) || 50;
    ...
    Filter.prototype.isProfane = function (value, customWords) {
        ...
        try {
            for (var _b = __values(__spreadArray(__spreadArray([], __read(customWords), false), __read(this.words.keys()), false)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var word = _c.value;
    ...
    Filter.prototype.evaluateSentence = function (text, customWords) {
        ...
        try {
            for (var words_1 = __values(words), words_1_1 = words_1.next(); !words_1_1.done; words_1_1 = words_1.next()) {
                ...
                try {
                    for (var _d = (e_3 = void 0, __values(__spreadArray(__spreadArray([], __read(customWords), false), __read(this.words.keys()), false))), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var dictWord = _e.value;
                        var severity = this.evaluateSeverity(dictWord, word);
    ...
    Filter.prototype.evaluate = function (text, customWords) {
        ...
        var similarityPercentTolerance = this.similarityPercent;
        var chars = {
            "4": "a",
            "3": "e",
            "1": "i",
        ...
        try {
            for (var words_2 = __values(words), words_2_1 = words_2.next(); !words_2_1.done; words_2_1 = words_2.next()) {
                ...
                try {
                    for (var dictWords_1 = (e_6 = void 0, __values(dictWords)), dictWords_1_1 = dictWords_1.next(); !dictWords_1_1.done; dictWords_1_1 = dictWords_1.next()) {
        ...
        var sentenceResult = this.evaluateSentence(text, customWords);
        profaneWords.push.apply(profaneWords, __spreadArray([], __read(sentenceResult.profaneWords), false));
        var processedText = text;
        if (this.replaceWith) {
            try {
                for (var profaneWords_2 = __values(profaneWords), profaneWords_2_1 = profaneWords_2.next(); !profaneWords_2_1.done; profaneWords_2_1 = profaneWords_2.next()) {
                    var word = profaneWords_2_1.value;
                    processedText = processedText.replace(new RegExp(word, "gi"), this.replaceWith);
                }
            }
                ...
                try {
                    if (profaneWords_2_1 && !profaneWords_2_1.done && (_c = profaneWords_2.return)) _c.call(profaneWords_2);
                }
