...
var Filter = /** @class */ (function () {
    ...
    function Filter(config) {
        ...
        this.words = words.map(function (word) { return word.toLowerCase(); });
    }
    ...
    Filter.prototype.addWords = function (customWords) {
        if (customWords === void 0) { customWords = []; }
        var newWords = __spreadArray(__spreadArray([], __read(this.words), false), __read(customWords), false);
        this.words = newWords.map(function (word) { return word.toLowerCase(); });
    };
    Filter.prototype.evaluate = function (text, customWords) {
        ...
        var dictWords = __spreadArray(__spreadArray([], __read(customWords), false), __read(this.words), false);
        var similarity = [];
        try {
